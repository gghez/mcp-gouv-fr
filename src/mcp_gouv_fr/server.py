...
def build_server(*, api_mounts: Sequence[ApiMount] | None = None) -> FastMCP:
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "each prefix (e.g. ``datagouv_``, ``geo_``, ``insee_``) identifies one portal or "
            "API family. "
            ...
            "``mcp_gouv_fr/apis/datagouv/tests/``, ``mcp_gouv_fr/apis/geo/tests/``, or "
            "``mcp_gouv_fr/apis/insee/tests/`` alongside "
